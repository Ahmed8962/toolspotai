/**
 * Publishes blog post 33 to Contentful (toolspotai.com).
 * Future-dated posts are saved as drafts until their publishedAt date.
 * Run: npm run contentful:publish-blog-33
 */
...
async function main() {
  ...
  console.log(`Publishing ${manifest.length} blog post(s) to Contentful`);
